-- ============================================================
-- File: raw_applications.sql
-- Purpose: Create the enterprise RAW applications table
-- ============================================================
...
COMMENT = 'Immutable RAW application records with source-file lineage';

DESC TABLE DBT_MINI_PROJECT.RAW.RAW_APPLICATIONS;